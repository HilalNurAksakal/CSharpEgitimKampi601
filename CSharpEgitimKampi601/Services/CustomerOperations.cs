...
namespace CSharpEgitimKampi601.Services
{
    public class CustomerOperations
    {
        ...
        {
            var connection= new MongoDbConnection();
            var customerColletion = connection.GetCustomersCollection();
            // Collection'a/Tabloya bağlantı 
            var customers = customerColletion.Find(new BsonDocument()).ToList();
            //yeni bson dokumanı oluşturulur ve bununla verileri çekilmesi sağlanır
